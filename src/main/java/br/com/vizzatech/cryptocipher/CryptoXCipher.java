...
public class CryptoXCipher {
     ...
     * @param cifraCesar
     *            em quantos numeros os caracteres ser„o trocados
     * @param charset
    ...
    /**
     * M√©todo getInstance com charset padr„o UTF-8
     * 
     * @param sal
    ...
    /**
     * MÈtodo getInstance com charset definido pelo usu·rio
     * 
     * @param sal
     *            chave para criar salt (sal)
     * @param algoritmo
    ...
    /**
     * Come a exception, n„o recomend·vel
     * @param str
     * @return
     */
    @Deprecated
    ...
    /**
     * Aplica o <a href=http://pt.wikipedia.org/wiki/Cifra_de_CÈsar>conceito Cifra de cesar</a> para
