...
public class TestCriptografiaISO88159
{
    ...
    public void setUp()
    {
        ...
        x = CryptoXCipher.getInstance(salt,"Blowfish", cesarCipher, Charset.forName("ISO-8859-1"));
        x2 = CryptoXCipher.getInstance(salt2,"Blowfish", cesarCipher, Charset.forName("ISO-8859-1"));
        assertNotNull(x);
        assertNotNull(x2);
